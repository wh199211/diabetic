...
def quad_kappa_loss(t, y , y_pow=1, eps=1e-15):
...
def quad_kappa_log_hybrid_loss_clipped(
        t, y , y_pow=1, log_cutoff=0.9, log_scale=0.5):
    log_loss_res = log_loss(t, y)
    kappa_loss_res = quad_kappa_loss(t, y , y_pow=y_pow)
